...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2022 at 10:27 AM
...
(200, 'Strong Accept', 'nice', 30001),
(201, 'Weak Accept', 'sada', 30001),
(202, 'Weak Accept', 'dmfisfs', 30001);
...
INSERT INTO `reviews_comment` (`columnId`, `paperId`, `userId`, `comment`, `date`) VALUES
(1, 200, 30001, 'pretty.', '2022/11/15 17:21:34'),
(2, 201, 30001, 'Try begging.', '2022/11/15 17:06:16'),
(3, 200, 30001, 'Nice', '2022/11/15 17:25:49'),
(4, 200, 30001, 'HOYAI', '2022/11/15 17:26:54'),
(5, 200, 30001, 'PEEEEE', '2022/11/15 17:27:02');
...
--
ALTER TABLE `allocated_papers`
  MODIFY `allocatedID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;
