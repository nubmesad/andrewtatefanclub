...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2022 at 06:03 PM
...
--
-- Dumping data for table `authors_rating`
--

INSERT INTO `authors_rating` (`id`, `reviewerId`, `paperId`, `rating`) VALUES
(2, 30001, 201, '5');
...
INSERT INTO `email` (`emailId`, `conferenceChairId`, `authorId`, `message`) VALUES
(28, 40001, 20005, '200 Accepted'),
(29, 40001, 20004, '201 Rejected'),
(30, 40001, 20002, '202 Accepted');
...
(200, 40001, 'Accepted', 'Sent'),
(201, 40001, 'Accepted', 'Sent'),
(202, 40001, 'Rejected', 'Sent');
...
(20004, 'n', 'n', 'n', 'david@gmail.com', 'Author'),
(20005, 'l', 'l', 'l', 'l@GMAIL.COM', 'Author'),
