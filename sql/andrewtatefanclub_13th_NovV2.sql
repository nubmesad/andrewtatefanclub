...
INSERT INTO `allocated_papers` (`allocatedID`, `paperId`, `reviewerId`) VALUES
(73, 200, 30001);
...
(200, 30001, 'Yes', 'Pending'),
(200, 30002, 'Yes', 'Pending'),
(201, 30001, 'Yes', 'Pending'),
(202, 30001, 'Yes', 'Pending'),
(203, 30001, 'Yes', 'Pending'),
(204, 30001, 'Yes', 'Pending'),
(222, 30002, 'Yes', 'Pending'),
(223, 30002, 'Yes', 'Pending'),
(236, 30002, 'Yes', 'Pending'),
(237, 30002, 'Yes', 'Pending'),
(238, 30002, 'Yes', 'Pending'),
(239, 30002, 'Yes', 'Pending'),
(240, 30002, 'Yes', 'Pending'),
(241, 30002, 'Yes', 'Pending'),
(242, 30002, 'Yes', 'Pending');
...
--
ALTER TABLE `allocated_papers`
  MODIFY `allocatedID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
...
--
ALTER TABLE `papers`
  MODIFY `paperId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=243;
